...
def run_cuj(page):
    ...
    # Click first pulse widget 'Applied'
    page.get_by_text("Applied", exact=True).click()
    page.wait_for_timeout(2000)
    page.screenshot(path="/home/jules/verification/screenshots/candidates_applied.png")
    page.wait_for_timeout(1000)
